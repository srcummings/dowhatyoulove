...
<head>
  ...
  <title>DWYL : do what you love</title>
  <!-- Font Awesome -->
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="https://mdbootstrap.com/docs/jquery/" target="_blank">About</a>
          </li>
          <li class="nav-item">
        ...
        <ul class="navbar-nav nav-flex-icons">
          <li class="nav-item">
            <a class="nav-link" href="https://www.instagram.com/dwylatwork/" target="_blank">
              <i class="fab fa-instagram"></i>
            </a>
          </li>
          <li class="nav-item">
            <a href="https://twitter.com/dwylatwork" class="nav-link" target="_blank">
              <i class="fab fa-twitter"></i>
            </a>
          </li>
          <li class="nav-item">
            <a href="https://www.youtube.com/channel/UCYzBdgF_QN_UvuwW4-egbSg" class="nav-link border border-light rounded"
              target="_blank">
              <i class="fab fa-youtube mr-2"></i>DWYL on YouTube
            </a>
          </li>
        </ul>
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <div class="carousel-item active">
        <div class="view">
          ...
          <video class="video-intro" autoplay loop muted>
            <source src="video/kritty_driving.mp4" type="video/mp4">
          </video>
      ...
      <div class="carousel-item">
        <div class="view">
          ...
          <!--Video source-->
          <video class="video-intro" autoplay loop muted>
            <source src="video/drew_arcade_imovie.mp4" type="video/mp4">
          </video>
      ...
      <div class="carousel-item">
        <div class="view">
          ...
          <!--Video source-->
          <video class="video-intro" autoplay loop muted>
            <source src="video/sunday_golf.mp4" type="video/mp4">
          </video>
